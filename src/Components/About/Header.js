...
import image from './Images/company_logo.jpg'
const Header = () => {
        ...
        {links.map((link, index) => (
          link.name === 'Services' ? (
            ...
            <Link
              key={index}
              to={link.path}
              className={`flex items-center text-gray-600 hover:text-orange-500 transition-colors duration-300 ${link.name === 'About' ? 'text-orange-500' : ''}`}
            >
              {link.name}
            </Link>
          )
          ...
          {links.map((link, index) => (
            link.name === 'Services' ? (
              ...
              <Link
                key={index}
                to={link.path}
                className={`text-gray-600 hover:text-orange-500 transition-colors duration-300 text-lg ${link.name === 'Contact Us' ? 'text-orange-500' : ''}`}
                onClick={() => setIsMenuOpen(false)}
              >
                {link.name}
              </Link>

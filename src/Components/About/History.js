...
const HistoryTimeline = () => {
  const events = [
    {
      year: 2018,
      description: "Launched our first product and established a strong market presence."
    },
    {
      year: 2020,
      description: "Expanded operations globally and introduced innovative technologies."
    },
    {
      year: 2022,
      description: "Achieved record-breaking growth and received industry recognition."
    }
  ];
